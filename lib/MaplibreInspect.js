...
function markInspectStyle(style) {
  return (0, _objectAssign["default"])(style, {
    metadata: (0, _objectAssign["default"])({}, style.metadata, {
...
function MaplibreInspect(options) {
  ...
  this.options = (0, _objectAssign["default"])({
...
MaplibreInspect.prototype._onSourceChange = function (e) {
  ...
  var previousSources = (0, _objectAssign["default"])({}, sources); //NOTE: This heavily depends on the internal API of Maplibre GL
...
MaplibreInspect.prototype._onMousemove = function (e) {
  ...
  if (!this._popupBlocked && this._popup) {
    ...
    if (this.options.selectThreshold === 0) {
      ...
      queryBox = [[e.point.x - this.options.selectThreshold, e.point.y + this.options.selectThreshold], // bottom left (SW)
...
MaplibreInspect.prototype.onAdd = function (map) {
  this._map = map; // if sources have already been passed as options
